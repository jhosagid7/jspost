...
<main>
    ...
    <div class="clearfix invoice-details">
        <table>
            <tr>
    ...
    <table class="item-table">
        ...
        <tr>
            ...
            <th class="text-right item-amount"><?php _trans('qty'); ?></th>
            <th class="text-right item-price"><?php _trans('price'); ?></th>
            <?php if ($show_item_discounts) : ?>
                <th class="text-right item-discount"><?php _trans('discount'); ?></th>
            <?php endif; ?>
            <th class="text-right item-total"><?php _trans('total'); ?></th>
        </tr>
        </thead>
        <tbody>
